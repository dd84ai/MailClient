...
namespace MailClient
{
    public partial class MainWindow : Form
    {
        ...
        {
            label1_NewMail.Text = "New loaded mails: " + "Loading...";
            this.Refresh();
            //Refresh mail
            ...
            if (MailQuan > RememberMailQuantity)
                label1_NewMail.Text = "New loaded mails: " + (MailQuan - RememberMailQuantity).ToString();
            else
                label1_NewMail.Text = "New loaded mails: " + 0;
        }
